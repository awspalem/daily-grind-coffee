 ...
 */
export function rateLimiter(config: RateLimitConfig = { windowSeconds: 60, maxRequests: 120 }) {
 ...
 */
export function sessionRateLimiter(config: RateLimitConfig & { sessionHeader?: string; scope?: string } = { windowSeconds: 600, maxRequests: 30 }) {
