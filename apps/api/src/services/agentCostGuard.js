...
function dailyKvKey(sessionToken, now = new Date()) {
...
async function readBudget(kv, sessionToken) {
 ...
 */
export async function checkAndReserveSessionBudget(env, sessionToken, estimatedTokens) {
    if (!sessionToken) {
