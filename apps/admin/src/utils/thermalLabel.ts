...
export interface RoasteryLotPreset {
  id: string;
  name: string;
  slug: string;
  region: string;
...
export const ROASTERY_LOT_PRESETS: RoasteryLotPreset[] = [
  {
...
export interface BagLabelConfig {
  ...
  batchId: string;
  grindType: string;
  bagSize: string; // '250g', '500g', '1kg'
  roasterName?: string;
  roasteryLocation?: string;
  brewGuideBaseUrl?: string;
}
